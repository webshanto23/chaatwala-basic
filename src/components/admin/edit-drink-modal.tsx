...
import { updateDrink } from "@/features/products/actions";
...
export default function EditDrinkModal({
  ...
  const [slug, setSlug] = useState(drink.slug);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await updateDrink(drink.id, fd);
    setLoading(false);
    ...
    pushToast("success", "Drink updated successfully");
