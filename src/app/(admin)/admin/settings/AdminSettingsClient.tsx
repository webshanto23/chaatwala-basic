...
export default function AdminSettingsClient({ userName, userEmail }: AdminSettingsClientProps) {
  ...
  const handleExportDatabase = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `database-export-${new Date().toISOString().slice(0, 10)}.csv`;
        ...
        <CardContent className="px-4 pb-4">
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Download the entire database as a CSV file for backup or analysis.
              </p>
            </div>
            ...
            >
              ...
              {isExporting ? "Exporting..." : "Export Database as CSV"}
            </Button>
          </div>
        </CardContent>
      </Card>
